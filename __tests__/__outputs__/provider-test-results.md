...
## ❌ <a id="r0" href="#r0">fixtures/external/flutter/provider-test-results.json</a>
...
### ✅ <a id="r0s0" href="#r0s0">test/builder_test.dart</a>
```
...
MultiProvider
  ...
  ✅ with ProxyProvider6
```
### ✅ <a id="r0s1" href="#r0s1">test/change_notifier_provider_test.dart</a>
```
...
ChangeNotifierProvider
  ...
  ✅ builder0
```
### ✅ <a id="r0s2" href="#r0s2">test/consumer_test.dart</a>
```
consumer
...
consumer6
  ...
  ✅ can be used inside MultiProvider
```
### ✅ <a id="r0s3" href="#r0s3">test/context_test.dart</a>
```
...
```
### ✅ <a id="r0s4" href="#r0s4">test/future_provider_test.dart</a>
```
...
```
### ✅ <a id="r0s5" href="#r0s5">test/inherited_provider_test.dart</a>
```
✅ regression test #377
...
```
### ✅ <a id="r0s6" href="#r0s6">test/listenable_provider_test.dart</a>
```
ListenableProvider
  ✅ works with MultiProvider
...
```
### ✅ <a id="r0s7" href="#r0s7">test/listenable_proxy_provider_test.dart</a>
```
...
```
### ✅ <a id="r0s8" href="#r0s8">test/multi_provider_test.dart</a>
```
MultiProvider
...
```
### ✅ <a id="r0s9" href="#r0s9">test/provider_test.dart</a>
```
✅ works with MultiProvider
Provider.of
...
```
### ✅ <a id="r0s10" href="#r0s10">test/proxy_provider_test.dart</a>
```
ProxyProvider
  ✅ throws if the provided value is a Listenable/Stream
  ✅ debugCheckInvalidValueType can be disabled
...
ProxyProvider variants
  ...
  ✅ ProxyProvider6
```
### ✅ <a id="r0s11" href="#r0s11">test/reassemble_test.dart</a>
```
✅ ReassembleHandler
✅ unevaluated create
✅ unevaluated create
```
### ✅ <a id="r0s12" href="#r0s12">test/selector_test.dart</a>
```
...
✅ Selector6
```
### ✅ <a id="r0s13" href="#r0s13">test/stateful_provider_test.dart</a>
```
✅ asserts
✅ works with MultiProvider
...
✅ dispose
```
### ✅ <a id="r0s14" href="#r0s14">test/stream_provider_test.dart</a>
```
✅ works with MultiProvider
...
StreamProvider()
  ...
  ✅ crashes if builder is null
```
### ❌ <a id="r0s15" href="#r0s15">test/value_listenable_provider_test.dart</a>
```
